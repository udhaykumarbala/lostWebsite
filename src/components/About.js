    ...
    <div className="bg-gray-100">
      ...
      <section className="bg-hero-bg bg-cover bg-center py-16">
        <div className="container mx-auto text-center text-white">
          <h1 className="text-4xl font-extrabold mb-4 text-theme-color">Embrace the Alpine Splendor at Lost Hostel Manali</h1>
      ...
      <section className="bg-gray-200 py-12">
        <div className="container mx-auto">
          <h2 className="text-3xl font-extrabold mb-4 text-theme-color">Why Lost Hostel Manali</h2>
          <p className="text-lg mb-4">
            Lost Hostel Manali is your sanctuary in the clouds. Tucked away in the bosom of the Himalayas, our doors open to an experience that transcends the ordinary.
      ...
      <section className="py-12">
        <div className="container mx-auto">
          ...
          <p className="text-lg mb-4">
            Manali, where the spirits soar high, became our newest chapter in November 2023. Lost Hostel has woven a tapestry of comfort and adventure here,
